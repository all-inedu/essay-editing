                                    ...
                                    <tr>
                                        <td align="center" class="inner"
                                            ...
                                            valign="middle"><span class="sg-image"><img alt="Verify" class="banner"
                                                    height="93" src="<?=base_url('assets/img/verify.png');?>"
                                                    style="border-width: 0px; margin-top: 30px; width: 270px; height: 150px;"
                                                    width="255"></span></td>
                                    </tr>
                                    <tr>
                                            ...
                                            <center>
                                                ...
                                                <p class="description center"
                                                    ...
                                                    <span
                                                        ...
                                                        Join and activate your account by clicking the button below<br>
                                                        <b>activate now</b>!</span></p>
                                                ...
                                                <div style="font-weight: 200; text-align: center; margin: 25px;">
                                                    <a style="padding:0.6em 1em;border-radius:600px;color:#ffffff;font-size:14px;text-decoration:none;font-weight:bold"
                                                        class="button-color"
                                                        href="<?=base_url();?>auth/verify?email=<?=$email;?>&token=<?=urlencode($token);?>">Activate
                                                        Account</a>
                                                </div>
                                                <!--[if (gte mso 9)|(IE)]><br>&nbsp;<![endif]-->
                                            </center>
