                ...
                <tbody>
                    <tr>
                        <td align="center" class="vervelogoplaceholder" height="143"
                            ...
                            valign="middle"><span class="sg-image"><a href="#" target="_blank"><img
                                        alt="All-in Eduspace" height="34"
                                        src="https://questions-bank.crm-allinedu.com/assets/img/logo-allin.png"
                                        style="border-width: 0px; width: 300px; height: 70px;" width="300"></a></span>
                        </td>
                    </tr>
                    <!-- Start of Email Body-->
                    <tr>
                                ...
                                <tbody>
                                    <tr>
                                        <td align="center" class="inner"
                                            ...
                                            valign="middle"><span class="sg-image"><img alt="Verify" class="banner"
                                                    height="120"
                                                    src="http://www.amicalolazipline.com/wp-content/uploads/2017/03/payment.png"
                                                    style="border-width: 0px; margin-top: 30px; width: 270px; height: 220px;"
                                                    width="255"></span></td>
                                    </tr>
                                    <tr>
                                        <td class="inner contents center"
                                            ...
                                            <center>
                                                ...
                                                <div style="font-weight: 200; text-align: left;">
                                                    <table width="100%">
                                                        <tr>
                                                ...
                                                <table class="tables">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php $real_price = $d['price'] + $d['discount'];?>
                                                            Rp. <?=number_format($d['price'], 0, '.', '.');?>
                                                            <br>
                                                            <del>
                                                                Rp. <?=number_format($real_price, 0, '.', '.');?>
                                                            </del>
                                                        </td>
                                                ...
                                                <table width="100%" style="text-align:center;">
                                                    ...
                                                    <tr>
                                                        <td><i>
                                                                Please make a payment via transfer with the total amount
                                                                of payment according to the program you will be
                                                                following :<br>
                                                                <br>Bank BCA<br>
                                                                Account number : 3122412 <br>
                                                                On behalf of : PT. Winner of Indonesian Education
                                                            </i></td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <br>If you have made a payment, please confirm payment by
                                                    ...
                                                    <tr>
                                                        <td>
                                                            ...
                                                            <a style="padding:0.6em 1em;border-radius:600px;color:#ffffff;font-size:14px;text-decoration:none;font-weight:bold"
                                                                class="button-color" href="#">Payment Confirmation</a>
                                                            <br><br> <br><br>
                                                        </td>
                                                    </tr>
                                                </table>
                        ...
                        <td
                            ...
                            <center>
                                <p
                                    ...
                                    <nobr><a class="tel" href="tel:2128102899"
                                            style="color:#a1a8ad;text-decoration:none;" target="_blank"><span
                                                style="white-space: nowrap">+62 852-9203-xxxx</span></a></nobr>
                                </p>

                                <p
                                    style="font-family:'Muli',Arial,sans-serif;Margin:0;text-align:center;Margin-right:auto;Margin-left:auto;font-size:15px;color:#a1a8ad;line-height:23px;">
                                    or email <a href="#" style="color:#a1a8ad;text-decoration:underline;"
                                        target="_blank">info@all-inedu.com</a></p>
                                ...
                                <p
                                    ...
                                    © All - In Eduspace <span style="white-space: nowrap">Jl. Panjang No. 36 5th
                                        Fl​</span>,
                                    <span style="white-space: nowrap">Kebon Jeruk, Jakarta Barat, </span> <span
                                        style="white-space: nowrap">11530</span></p>
                            </center>
                        </td>
                    </tr>
                    <!-- whitespace -->
