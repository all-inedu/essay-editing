...
<div class="container-fluid">
    ...
    <div class="card mb-5 animated--grow-in">
        <div class="card-header py-3">
            ...
            <a href="<?=base_url('editor/essay-prompt/delete/') . $prompt['id_essay_prompt'];?>"
            ...
            <a href="<?=base_url('editor/essay-prompt/edit/') . $prompt['id_essay_prompt'];?>"
                class="btn btn-sm btn-warning float-right ml-2" title="Edit"><i class="fas fa-pencil-alt"></i></a>
            <a href="<?=base_url('editor/essay-prompt');?>" class="btn btn-sm btn-primary float-right"><i
