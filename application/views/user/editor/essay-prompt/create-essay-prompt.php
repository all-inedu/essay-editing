 ...
 <div class="container-fluid">
     <div class="card mb-5 animated--grow-in">
         <div class="card-header py-3">
             <div class="m-0 float-left pt-2"><i class="fas fa-plus-circle"></i>&nbsp;
                 New Essay Prompt
             </div>
             <a href="<?=base_url('editor/essay-prompt');?>"
                 class="btn btn-sm btn-outline-primary float-right text-white"><i class="fas fa-arrow-left"></i></a>
         </div>
         <div class="card-body">
             <form method="post" action="<?=base_url('editor/essay-prompt/create');?>">
                 <div class="row">
                     <div class="col-md-12">
