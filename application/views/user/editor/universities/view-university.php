             ...
             <div class="card mb-5 animated--grow-in">
                 <div class="card-header">
                     <div class="m-0 float-left pt-2"><i class="fas fa-university"></i>&nbsp;
                         Universites</div>
                     <a href="<?=base_url('editor/university/delete/') . $univ['id_univ'];?>"
                         class="btn btn-sm btn-danger float-right ml-2 delete-button" title="Delete"
                         data-message="university"><i class="fas fa-trash"></i></a>
                     <a href="<?=base_url('editor/university/edit/') . $univ['id_univ'];?>"
                         class="btn btn-sm btn-warning float-right ml-2" title="Edit"><i
                             class="fas fa-pencil-alt"></i></a>
                     <a href="<?=base_url('editor/university');?>" class="btn btn-sm btn-primary float-right"
                         title="Back to List"><i class="fas fa-arrow-left"></i></a>
                 </div>
                 <div class="card-body">
                     <div class="row">
                         <div class="col-md-12">
