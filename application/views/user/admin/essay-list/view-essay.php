                    ...
                    <div class="card-header2">
                        ...
                        <div class="float-right">
                            <a class="btn btn-sm text-white"
                                href="<?=base_url('admin/clients/view/'.$essay['id_clients']);?>" data-toggle="tooltip"
                                data-placement="left" title="Student's Detail" target="_blank">
                            ...
                            <div class="col-md-4">
                                <div class="toast" data-autohide="false">
                                    <div class="toast-header">
                                        <strong
                                            class="mr-auto text-primary"><?=$er['first_name'].' '.$er['last_name'];?></strong>
                                        <small
                                            class="text-muted"><?=date('D, d M Y', strtotime($er['created_at']));?></small>
        ...
        <div class="modal-content">
            ...
            <form action="" method="post">
                    ...
                    <table class="table table-bordered text-dark" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="align-middle"><?=$e['graduated_from'];?></td>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary btn-sm">Assign To Editors</button>
                </div>
            </form>
        </div>
    </div>
