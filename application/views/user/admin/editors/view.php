            ...
            <div class="card mb-2">
                <a href="<?=base_url('admin/essay-list/verify/'.$editors['id_editors']);?>"
                    ...
                    <div class="card-body text-center">
                        <h1 id="complete"></h1>
                        <h6>Completing Student's Essay</h6>
                    </div>
                </a>
            </div>
            <div class="card mb-2">
            ...
            <div class="card mb-2 animated--grow-in">
                ...
                <div class="card-body">
                    <form method="post" action="">
                            ...
                            <div class="col-md-12">
                                ...
                                <select name="position" class="form-control select2">
                                    ...
                                    <option value="<?=$p['id_position'];?>"
                                        <?php if($p['id_position']==$editors['position']) { echo 'selected';}?>>
                                        <?=$p['position_name'];?>
                                    </option>
                                    <?php endforeach; ?>
                                </select>
                        ...
                        <hr>
                        <div class="text-center">
                            <button type="submit" class="btn btn-sm btn-primary">Update Editor</button>
                        </div>
                    </form>
                </div>
            </div>
