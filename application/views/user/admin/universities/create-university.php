 ...
 <div class="container-fluid">
     <div class="row">
         <div class="col-md-3">
             <div class="card mb-2">
                 <div class="card-body">
                     <?=form_open_multipart('admin/university/create');?>
         ...
         <div class="col-md-9">
             <div class="card mb-5 animated--grow-in">
                 <div class="card-header">
                     <div class="pt-2 float-left"><i class="fas fa-university"></i>&nbsp;
                         New Universites</div>
                     <a href="<?=base_url('admin/university');?>" class="btn btn-sm btn-outline-primary float-right"><i
