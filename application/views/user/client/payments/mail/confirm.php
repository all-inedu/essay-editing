                                        ...
                                        <td class="inner contents center"
                                            ...
                                            <center>
                                                <p class="h1 center"
                                                    ...
                                                    Confirmation Payment from Client</p>
                                                ...
                                                <div style="font-weight: 200; text-align: left;">
                                                    <table width="100%">
                                                        ...
                                                        <tr>
                                                            <td>Total Payment</td>
                                                            <td>:</td>
                                                            <td>Rp. <?=number_format($trans['total'], 0, '.', '.');?>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>Transaction Date</td>
                                                            <td>:</td>
                                                            <td><?=date("D, d M Y, h:i:s", strtotime($trans['created_at']));?>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>Confirm Date</td>
                                                            <td>:</td>
                                                            <td><?=date("D, d M Y, h:i:s", strtotime($trans['uploaded_at']));?>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </div>
