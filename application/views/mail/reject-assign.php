                                                                            ...
                                                                            <tr>
                                                                                <td width="404">
                                                                                    ...
                                                                                    <div class="text2"
                                                                                        ...
                                                                                        <br>
                                                                                        <b>Essay Deadline:</b>
                                                                                        <?=date('D, d M Y', strtotime($client['essay_deadline']));?>
                                                                                        <br>
                                                                                        <b>Application Due Date:</b>
                                                                                        <?=date('D, d M Y', strtotime($client['application_deadline']));?>
                                                                                        <br>
                                                                                        <b>Target University:</b>
                                                                                        <?=$client['university_name'];?>
                                                                                        <br>
                                                                                        <b>Essay Prompt:</b>
                                                                                        <i><?=$client['essay_prompt'];?></i>
                                                                                        <br>
                                                                                        <p>for the following reason: </p>
                                                                                        <br>
                                                                                        <?=$notes;?>
                                                                                        <br>
                                                                                        <p>Please assign this essay to another editor immediately.</p>
                                                                                        <br>
                                                                                    </div>
                                                                                </td>
                                                                            </tr>
