                                                                            ...
                                                                            <tr>
                                                                                <td width="404">
                                                                                    ...
                                                                                    <div class="text2"
                                                                                        ...
                                                                                        <br>
                                                                                        <p><?=$student['first_name'];?>'s essay, <?=$student['essay_title'];?>, has been reviewed by our essay editor, <?=$editor['first_name'];?>, and is now ready to be returned to your mentee.</p>
                                                                                        <br>
                                                                                        ...
                                                                                        <br>
                                                                                        <?php if($editor['managing_file']) { ?>
                                                                                        <a href="<?=base_url('upload_files/program/essay/revised/'.$editor['managing_file']);?>"
                                                                                        ...
                                                                                        >Download</a>
                                                                                        <?php } else { ?>
                                                                                        <a href="<?=base_url('upload_files/program/essay/editors/'.$editor['attached_of_editors']);?>"
                                                                                        style="background-color: #4CAF50;border: none;color: white; padding: 8px 32px; text-align: center; text-decoration: none; display: inline-block; font-size: 14px; margin: 4px 2px; cursor: pointer;"
                                                                                        >Download</a>
                                                                                        <?php } ?>
