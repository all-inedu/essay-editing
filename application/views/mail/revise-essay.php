                                                                            ...
                                                                            <tr>
                                                                                <td width="404">
                                                                                    ...
                                                                                    <div class="text2"
                                                                                        ...
                                                                                        <br>
                                                                                        <p>After reviewing your revision of <?=$essay['first_name'];?>'s essay, <?=$essay['essay_title'];?>, <?=$managing['first_name'].' '.$managing['last_name'];?> is asking you to please give it another look.</p> 
                                                                                        <br>
