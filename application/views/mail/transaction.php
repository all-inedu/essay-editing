                ...
                <table width="650" border="0" cellspacing="0" cellpadding="0" class="mobile-shell">
                    <tr>
                        <td class="td"
                            ...
                            <!-- Top Bar -->
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#2079a3">
                                <tr>
                                    <!-- Column -->
                                    <th class="column-top"
                                                                ...
                                                                <multiline>
                                                                    <a href="<?=base_url();?>" target="_blank"
                                                                        ...
                                                                        style="color:#ffffff; text-decoration:none"><span
                                                                            class="link-white-u"
                                                                            style="color:#ffffff; text-decoration:none">Home</span></a>
                                                                </multiline>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td class="inner contents center"
                                                                    style="padding-top:15px;padding-bottom:15px;padding-right:0px;padding-left:0px;text-align:left;">
                                                                    <center>
                                                                        <div
                                                                            style="font-weight: 200; text-align: left;">
                                                                            <table width="100%">
                                                                                <tr>
                                                                        ...
                                                                        <table width="100%"
                                                                            style="text-align:justify; color:#3a677c; font-family:Arial,sans-serif;">
                                                                            <tr valign="top">
                                                                                <td><b>Notes :</b></td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td>
                                                                                    ...
                                                                                    transfer with the total amount
                                                                                    of payment according to the
                                                                                    program you will be
                                                                                    following.
                                                                                    <br>
                                                                                    <blockquote>
                                                                            ...
                                                                            <tr>
                                                                                <td style="text-align:right;">
                                                                                    ...
                                                                                    <a href="<?=base_url();?>"
                                                                                        target="_blank"
                                                                                        class="link-green-u"
                                                                                        style="color:#3cb371; text-decoration:none;background:#2079A3; padding:10px 20px 10px 20px;"><span
                                                                                            class="link-green-u"
                                                                                            style="color:#fff; text-decoration:none;"><b>
                                                                                                Confirmation</b></span></a>
                                                                                </td>
                                                                            </tr>
                                                                        </table>
