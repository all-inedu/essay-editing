...
class Essay_prompt extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('user/admin/essay-prompt/index', $data);
    ...
    public function create()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('templates/user/sidebar', $data);
            $this->load->view('templates/user/topbar');
            $this->load->view('user/admin/essay-prompt/create-essay-prompt', $data);
            $this->load->view('templates/user/footer');
        } else {
            $data = [
    ...
    public function view($id)
    {
        ...
        $this->load->view('templates/user/sidebar', $data);
        $this->load->view('templates/user/topbar');
        $this->load->view('user/admin/essay-prompt/view-essay-prompt', $data);
        $this->load->view('templates/user/footer');
    }
    ...
    public function edit($id)
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            redirect('admin/essay-prompt/view/' . $id);
        }
