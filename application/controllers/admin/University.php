...
class University extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('user/admin/universities/index', $data);
    ...
    public function create()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('templates/user/sidebar', $data);
            $this->load->view('templates/user/topbar');
            $this->load->view('user/admin/universities/create-university');
            $this->load->view('templates/user/footer');
        } else {
            ...
            if ($image) {
                ...
                if ($this->upload->do_upload('image')) {
                    ...
                    redirect('admin/university/create');
                }
    ...
    public function view($id)
    {
        ...
        $this->load->view('templates/user/sidebar', $data);
        $this->load->view('templates/user/topbar');
        $this->load->view('user/admin/universities/view-university', $data);
        $this->load->view('templates/user/footer');
    }
        ...
        if ($this->form_validation->run() == false) {
            ...
            if ($image) {
                ...
                if ($this->upload->do_upload('image')) {
                    ...
                    $this->session->set_flashdata('success', 'University has been created');
                    redirect('admin/university/view/' . $id);
